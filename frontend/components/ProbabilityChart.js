...
export function ProbabilityChart({ points }) {
  ...
  return (
    <div className="h-64 w-full rounded-xl border border-slate-800 bg-panel p-3">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="probabilityYes" stroke="#34d399" strokeWidth={2.5} dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
